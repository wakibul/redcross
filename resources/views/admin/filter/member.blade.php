                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-3">
                            <div class="form-group  form-float">
                                <select class="form-control show-tick" name="member_package_id">
                                    <option value="">Select Memeber Package</option>
                                    @foreach($memberPackages as $key=>$memberPackage)
                                    <option value="{{$memberPackage->id}}" @if(request('member_package_id') == $memberPackage->id) selected @endif>{{$memberPackage->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
