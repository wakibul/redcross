...
<script src="{{asset('public/assets/js/vendors/jquery-jvectormap-2.0.3.min.js')}}"></script>
<script src="{{asset('public/assets/js/vendors/jquery-jvectormap-de-merc.js')}}"></script>
<script src="{{asset('public/assets/js/vendors/jquery-jvectormap-world-mill.js')}}"></script>
