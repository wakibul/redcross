...
<a href="{{route('admin.donation.export_blood_donation',['state_id'=>Request()->state_id,'from_date'=>Request()->from_date,'to_date'=>Request()->to_date])}}" class="btn btn-success" target="_blank">Export to excel</a>
    <table class="table">
        <thead>
            <tr>
                <th>#</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <a href="{{route('admin.donation.pdf',Crypt::encrypt($donation->id))}}" class="btn btn-sm btn-orange"  target="_blank">PDF</a>
